"""
Django settings for movie_service project.
...
SECRET_KEY = 'django-insecure-lzfx+=#!zpi5knwl#7*fpv8r$!g+j3m_5ex%jq&vb-djo2_g-k'
...
ROOT_URLCONF = 'movie_service.urls'
